...
import static com.example.zoomir.DatabaseConnector.getsetzakazObservableList;
...
public class Zakaz {
    ...
    @FXML
    private TableColumn<getsetzakaz, Date> datatab;
    ...
    @FXML
    private TableColumn<getsetzakaz, Integer> idd;

    @FXML
    private Button izm;

    @FXML
    private TableColumn<getsetzakaz, Integer> koll;
    ...
    @FXML
    private TableColumn<getsetzakaz, String> nazv;
    ...
    @FXML
    private TableView<getsetzakaz> tabl;
    ...
    ObservableList<getsetzakaz> listBAP; //Название массива
    Connection conn1 = null; //Конектор равен нулю
    PreparedStatement pst1 = null;
    @FXML
    void data(ActionEvent event) {
        // Пример обработки выбора даты
        LocalDate selectedDate = data.getValue();
        if(selectedDate != null) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Выбранная дата");
            alert.setHeaderText(null);
            alert.setContentText("Вы выбрали дату: " + selectedDate);
            alert.showAndWait();
        } else {
    ...
    void dob(ActionEvent event) {
        ...
        // Исправленный SQL-запрос: замените '.' на ','
        String sql = "INSERT INTO zakaz (id, дата, название, количество) VALUES (?, ?, ?, ?)";

        try {
            // Проверка на пустые значения
            if (id.getText().trim().isEmpty() || nazvan.getText().trim().isEmpty() || kolvo.getText().trim().isEmpty() || data.getValue() == null) {
            ...
            // Установка даты
            pst1.setDate(2, java.sql.Date.valueOf(data.getValue())); // Преобразуем LocalDate в java.sql.Date

            pst1.setString(3, nazvan.getText().trim()); // Установка названия
            pst1.setInt(4, Integer.parseInt(kolvo.getText().trim())); // Установка количества
    ...
    void izm(ActionEvent event) {
        try {
            ...
            String sql = "UPDATE zakaz SET id= '" + value1 + "',название= '" + value2 + "',количество= '"+ value3 + "' where id='" + value1 + "' ";
    ...
    void nazad(ActionEvent event) throws IOException {
        FXMLLoader fmxlLoader = new FXMLLoader(HelloApplication.class.getResource("zakaz.fxml"));
    ...
    void ydal(ActionEvent event) {
        ...
        String sql = "DELETE FROM zakaz WHERE id = ?";
    ...
    void search_user() {
        ...
        FilteredList<getsetzakaz> filteredData = new FilteredList<>(listBAP, b -> true);
        ...
        SortedList<getsetzakaz> sortedData = new SortedList<>(filteredData);
    ...
    private void fillFieldsFromSelectedRow(getsetzakaz selectedProduct) {
        id.setText(String.valueOf(selectedProduct.getId()));
        data.setValue(selectedProduct.getДата().toLocalDate());
    ...
    private void clearFormFields() {
        ...
        nazvan.clear();
        kolvo.clear();
        assert data != null : "fx:id=\"data\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert datatab != null : "fx:id=\"datatab\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert dob != null : "fx:id=\"dob\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert id != null : "fx:id=\"id\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert idd != null : "fx:id=\"idd\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert izm != null : "fx:id=\"izm\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert koll != null : "fx:id=\"koll\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert kolvo != null : "fx:id=\"kolvo\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert nazad != null : "fx:id=\"nazad\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert nazv != null : "fx:id=\"nazv\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert nazvan != null : "fx:id=\"nazvan\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert obn != null : "fx:id=\"obn\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert poisk != null : "fx:id=\"poisk\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert tabl != null : "fx:id=\"tabl\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert vixod != null : "fx:id=\"vixod\" was not injected: check your FXML file 'zakaz.fxml'.";
        assert ydal != null : "fx:id=\"ydal\" was not injected: check your FXML file 'zakaz.fxml'.";
